...
//
    ...
    for ($xz = 0; $xz < 3; $xz++) {
        ...
        //  INICIA - CAMBIOS HECHOS POR JJ - 25-04-2021
        $xcadena = str_replace("UN MIL NOVECIENTOS", "MIL NOVECIENTOS", $xcadena); // EJE 1984
        $xcadena = str_replace("DOS MIL VEINTIúN", "DOS MIL VEINTIUNO", $xcadena); // la tílde produce fallas
        //  FINALIZAN - CAMBIOS HECHOS POR JJ - 25-04-2021
    } // ENDFOR ($xz)
    return trim($xcadena);
}
